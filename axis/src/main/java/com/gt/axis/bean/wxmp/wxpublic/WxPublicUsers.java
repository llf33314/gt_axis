 ...
 */
public class WxPublicUsers {

    private Integer id; // ID

    private Integer busUserId; // 商家ID

    private String authorizerInfo; // 昵称[非必须]

    private String headImg; // 头像[非必须]

    private Integer serviceTypeInfo; // 0、1:订阅号，2：服务号
    ...
    private String mchId; // 商户号[非必须]

    private String apiKey; // 商户密钥[非必须]
